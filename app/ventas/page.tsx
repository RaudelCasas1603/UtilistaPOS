...
export default function VentasPage() {
  ...
  const [customer] = useState("Cliente general")
  ...
  return (
    <div className="h-full min-h-0 overflow-hidden bg-background p-4 pt-4 md:p-6">
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-6 overflow-hidden xl:grid-cols-[1.55fr_0.95fr]">
          ...
          <div className="flex min-h-0 flex-col overflow-hidden">
            <Card className="flex min-h-0 flex-1 flex-col overflow-hidden border-border/60 shadow-sm">
              ...
              <CardContent className="flex flex-1 flex-col justify-between space-y-5 overflow-hidden">
                <div className="space-y-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
                      <Button variant="outline" className="h-12 gap-3">
